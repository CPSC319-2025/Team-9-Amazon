...
import PotentialCandidateReportPage from "../pages/HiringManager/PotentialCandidateReportPage";
    ...
    <>
      ...
      <Routes>
        ...
        >
          ...
          />
          <Route
            path="candidate-report/:candidateEmail/:originalJobPostingId/potential"
            element={
              <DraftGuard>
                <PotentialCandidateReportPage />
              </DraftGuard>
            }
          />
        </Route>
