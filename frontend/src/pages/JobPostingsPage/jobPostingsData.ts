...
export const jobPostingsData: Job[] = [
  ...
  },
  {
    ...
    location: "Seattle, WA",
    description: "Looking for a software engineer to join our team here in Seattle, WA.",
    job_type: "Full-time",
    department: "Engineering",
    posted_at: "2024-01-01",
    qualifications: [
      "5+ years of software development experience",
      "Strong expertise in distributed systems and microservices",
  ...
  },
  {
    ...
    description: "Looking for a data scientist to join our team here in New York, NY.",
    department: "Data",
    job_type: "Full-time",
    posted_at: "2024-01-01",
    qualifications: [
