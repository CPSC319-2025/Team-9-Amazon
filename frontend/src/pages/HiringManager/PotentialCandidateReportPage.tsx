...
import {
  ...
  useGetPotentialApplicationsSummary,
...
export default function PotentialCandidateReportPage() {
  const { jobPostingId, candidateEmail, originalJobPostingId } = useParams();
  ...
  const { 
    ...
    isLoading,
    error,
  } = useGetPotentialApplicationsSummary(jobPostingId!, candidateEmail!, originalJobPostingId!);
